...
class CheckAndStartSentinelJob implements ShouldBeEncrypted, ShouldQueue
{
    ...
    public function handle(): void
    {
        ...
        $sentinelFound = instant_remote_process(['docker inspect hostly-sentinel'], $this->server, false);
        ...
        $runningVersion = instant_remote_process(['docker exec hostly-sentinel sh -c "curl http://127.0.0.1:8888/api/version"'], $this->server, false);
