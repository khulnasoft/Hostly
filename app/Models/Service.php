...
#[OA\Schema(
    ...
    properties: [
        ...
        'docker_compose' => ['type' => 'string', 'description' => 'The docker-compose.yml file that is parsed and modified by Hostly.'],
...
class Service extends BaseModel
{
    ...
    public function saveComposeConfigs()
    {
        ...
        $envs_from_hostly = $this->environment_variables()->get();
        $sorted = $envs_from_hostly->sortBy(function ($env) {
