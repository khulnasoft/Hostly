...
class StartMongodb
{
    ...
    public function handle(StandaloneMongodb $database)
    {
        ...
        if (isDev()) {
            $this->configuration_dir = '/var/lib/docker/volumes/hostly_dev_hostly_data/_data/databases/'.$container_name;
        }
        ...
        $docker_compose = [
            'services' => [
                $container_name => [
                    ...
                    'labels' => [
                        'hostly.managed' => 'true',
                        'hostly.type' => 'database',
                        'hostly.databaseId' => $this->database->id,
                    ],
                    'healthcheck' => [
                        'test' => [
                            'CMD',
    ...
    private function generate_environment_variables()
    {
        ...
        add_hostly_default_environment_variables($this->database, $environment_variables, $environment_variables);
