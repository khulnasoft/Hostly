...
class ComplexStatusCheck
{
    ...
    public function handle(Application $application)
    {
        ...
        foreach ($servers as $server) {
            ...
            $container = instant_remote_process(["docker container inspect $(docker container ls -q --filter 'label=hostly.applicationId={$application->id}' --filter 'label=hostly.pullRequestId=0') --format '{{json .}}'"], $server, false);
