...
[FILTER]
    Name                modify
    Match               *
    Set                 hostly.server_name {$server->name}
    Rename              HOSTLY_APP_NAME hostly.app_name
    Rename              HOSTLY_PROJECT_NAME hostly.project_name
    Rename              HOSTLY_SERVER_IP hostly.server_ip
    Rename              HOSTLY_ENVIRONMENT_NAME hostly.environment_name
[OUTPUT]
    Name nrlogs
    Match *
...
services:
  hostly-log-drain:
    ...
    container_name: hostly-log-drain
