...
namespace App\Actions\HostlyTask;

use App\Data\HostlyTaskArgs;
use App\Jobs\HostlyTask;
use Spatie\Activitylog\Models\Activity;

/**
 * The initial step to run a `HostlyTask`: a remote SSH process
 * with monitoring/tracking/trace feature. Such thing is made
 * possible using an Activity model and some attributes.
 */
class PrepareHostlyTask
{
    protected Activity $activity;

    protected HostlyTaskArgs $remoteProcessArgs;

    public function __construct(HostlyTaskArgs $remoteProcessArgs)
    {
