...
class Test extends Notification implements ShouldQueue
{
    ...
    public function toMail(): MailMessage
    {
        ...
        $mail->subject('Hostly: Test Email');
    ...
    public function toDiscord(): DiscordMessage
    {
        $message = new DiscordMessage(
            ...
            description: 'This is a test Discord notification from Hostly. :cross_mark: :warning: :information_source:',
    ...
    {
        return [
            'message' => 'Hostly: This is a test Telegram notification from Hostly.',
            'buttons' => [
                [
