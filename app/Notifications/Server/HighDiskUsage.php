...
class HighDiskUsage extends CustomEmailNotification
{
    ...
    public function toMail(): MailMessage
    {
        ...
        $mail->subject("Hostly: Server ({$this->server->name}) high disk usage detected!");
    ...
    public function toDiscord(): DiscordMessage
    {
        ...
        $message->addField('What to do?', '[Link](https://hostly.khulnasoft.com/docs/knowledge-base/server/automated-cleanup)', true);
    ...
    {
        return [
            'message' => "Hostly: Server '{$this->server->name}' high disk usage detected!\nDisk usage: {$this->disk_usage}%. Threshold: {$this->server_disk_usage_notification_threshold}%.\nPlease cleanup your disk to prevent data-loss.\nHere are some tips: https://hostly.khulnasoft.com/docs/knowledge-base/server/automated-cleanup.",
        ];
    }
}
