...
class NotifyDemo extends Command
{
    ...
    {
        style('hostly')->color('#9333EA');
        style('title-box')->apply('mt-1 px-2 py-1 bg-hostly');
        ...
        <div>
            ...
            <p class="mt-1 ml-1 ">
              Demo Notify <strong class="text-hostly">=></strong> Send a demo notification to a given channel.
            </p>
            <p class="px-1 mt-1 ml-1 bg-hostly">
              php artisan app:demo-notify {channel}
            </p>
            <div class="my-1">
                <div class="text-yellow-500"> Channels: </div>
                <ul class="text-hostly">
                    <li>email</li>
                    <li>slack</li>
                    <li>discord</li>
                    <li>telegram</li>
