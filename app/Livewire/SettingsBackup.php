...
class SettingsBackup extends Component
{
    ...
    public function mount()
    {
        if (! isInstanceAdmin()) {
            ...
            $this->database = StandalonePostgresql::whereName('hostly-db')->first();
    ...
    public function addHostlyDatabase()
    {
        try {
            $server = Server::findOrFail(0);
            $out = instant_remote_process(['docker inspect hostly-db'], $server);
