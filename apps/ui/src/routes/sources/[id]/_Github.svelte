		...
		<form on:submit|preventDefault={newGithubApp} class="py-4">
			...
			<div class="grid gap-2 grid-cols-2 auto-rows-max">
				...
				<Setting
					...
					description="System Wide Git are available to all the users in your Hostly instance. <br><br> <span class='font-bold text-warning'>Use with caution, as it can be a security risk.</span>"
				/>
			</div>
		</form>
			...
			<div class="grid gap-2 grid-cols-2 auto-rows-max mt-4">
				...
				{#if $appSession.isAdmin}
					<Setting
						...
						description="System Wide Git Sources are available to all the users in your Hostly instance. <br><br> <span class='font-bold text-warning'>Use with caution, as it can be a security risk.</span>"
					/>
				{/if}
			</div>
		</form>
