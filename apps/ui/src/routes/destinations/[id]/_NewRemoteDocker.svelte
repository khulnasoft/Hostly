...
<div class="text-center flex justify-center">
	<SimpleExplainer
        ...
        <br>See <a class='text-white' href='https://docs.coollabs.io-v3/hostly/destinations#remote-docker-engine' target='blank'>docs</a> for more details."
	/>
</div>
<div class="flex justify-center px-6 pb-8">
	<form on:submit|preventDefault={handleSubmit} class="grid grid-flow-row gap-2 py-4">
		...
		<div class="grid grid-cols-2 items-center lg:pl-10">
			<Setting
				id="isHostlyProxyUsed"
				bind:setting={payload.isHostlyProxyUsed}
				on:click={() => (payload.isHostlyProxyUsed = !payload.isHostlyProxyUsed)}
