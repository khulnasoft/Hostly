...
<div class="flex lg:flex-row flex-col h-screen">
	<div class="bg-neutral-focus h-screen lg:flex hidden flex-col justify-end p-20 flex-1">
		<h1 class="title lg:text-6xl mb-5 border-gradient">Hostly</h1>
	...
	<div class="flex flex-1 flex-col lg:max-w-2xl">
			...
			{#if $appSession.whiteLabeledDetails.icon}
				<div class="avatar" style="width: 40px; height: 40px">
					<img
						...
						alt="Icon for white labeled version of Hostly"
					/>
				</div>
			{:else}
				<div>
					<div class="avatar" style="width: 40px; height: 40px">
						<img src="favicon.png" alt="Hostly icon" />
					</div>
				</div>
				<div class="prose">
					<h4>Hostly</h4>
		...
		>
			...
			{#if browser && window.location.host === 'demo.hostly.io'}
