...
<div class="max-w-screen-2xl mx-auto px-9">
	...
	<div class="flex flex-row items-center">
		...
		<DocLink url="https://docs.coollabs.io/hostly-v3/applications/#public-repository-from-git" />
	</div>
	<PublicRepository />
	<div class="flex flex-row items-center pt-10">
		<div class="title py-4 pr-4">Simple Dockerfile <Beta /></div>
		<DocLink url="https://docs.coollabs.io/hostly-v3/applications/#simple-dockerfile" />
	</div>
