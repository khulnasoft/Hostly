...
{:else}
	...
	<div class="max-w-screen-2xl mx-auto px-10">
		<div class="title pb-2">Hostly Base</div>
		<div class="flex flex-wrap justify-center">
			{#each buildPacks.filter((bp) => bp.isHostlyBuildPack === true && bp.type === 'base') as buildPack}
				<div class="p-2">
					<BuildPack
						{packageManager}
						{buildPack}
	...
	<div class="max-w-screen-2xl mx-auto px-10">
		<div class="title pb-2">Hostly Specific</div>
		<div class="flex flex-wrap justify-center">
			{#each buildPacks.filter((bp) => bp.isHostlyBuildPack === true && bp.type === 'specific') as buildPack}
				<div class="p-2">
					<BuildPack {packageManager} {buildPack} {scanning} bind:foundConfig />
				</div>
			{/each}
