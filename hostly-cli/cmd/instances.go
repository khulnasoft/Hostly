...
var instancesCmd = &cobra.Command{
	Use:   "instances",
	Short: "Hostly instance related commands.",
}
...
var listInstancesCmd = &cobra.Command{
	Use:   "list",
	Short: "List all Hostly instances.",
	Run: func(cmd *cobra.Command, args []string) {
...
var removeInstanceCmd = &cobra.Command{
	...
	Short:   "Remove a Hostly instance.",
...
var setTokenCmd = &cobra.Command{
	...
	Args:    cobra.ExactArgs(2),
	Short:   "Set token for the given Hostly instance.",
	Run: func(cmd *cobra.Command, args []string) {
		Name = args[0]
		Token = args[1]
		var found interface{}
...
var setDefaultCmd = &cobra.Command{
	...
	Args:    cobra.ExactArgs(1),
	Short:   "Set the default Hostly instance.",
