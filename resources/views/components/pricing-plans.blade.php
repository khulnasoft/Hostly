    ...
    <div class="px-6 mx-auto lg:px-8">
        ...
        <div class="p-4 rounded bg-coolgray-400">
            <h2 id="tier-hobby" class="flex items-start gap-4 text-4xl font-bold tracking-tight">Unlimited Trial
                <x-forms.button><a class="font-bold dark:text-white hover:no-underline"
                        href="https://github.com/khulnasoft/hostly">Get Started</a></x-forms.button>
            </h2>
        ...
        <div class="grid grid-cols-1 gap-10 md:grid-cols-2 gap-y-28">
            ...
            <div>
                ...
                <div class="mt-1 text-base leading-7 text-gray-300">
                    Once you connected your server, Hostly will start managing it and do a
            ...
            <div>
                ...
                <div class="mt-1 text-base leading-7 text-gray-300">
                    ...
                    you decide to stop using Hostly, you can still continue to manage your
                    deployed resources.
                </div>
            </div>
            ...
            <div>
                ...
                <div class="mt-1 text-base leading-7 text-gray-300">
                    Hostly will automatically monitor your configured servers and deployed
