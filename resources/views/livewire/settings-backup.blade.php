<div>
    ...
    <div class="flex flex-col">
        ...
        <div class="pb-4">Backup configuration for Hostly instance.</div>
        <div>
            ...
            @else
                To configure automatic backup for your Hostly instance, you first need to add a database resource
                into Hostly.
                <x-forms.button class="mt-2" wire:click="addHostlyDatabase">Configure Backup</x-forms.button>
            @endif
        </div>
    </div>
</div>
