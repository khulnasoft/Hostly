<div>
    <x-slot:title>
        {{ data_get_str($server, 'name')->limit(10) }} > Advanced | Hostly
    </x-slot>
                ...
                <div class="flex items-center gap-2">
                    ...
                    <x-modal-confirmation title="Confirm Docker Cleanup?" buttonTitle="Trigger Manual Cleanup"
                        isHighlightedButton submitAction="manualCleanup" :actions="[
                            'Permanently deletes all stopped containers managed by Hostly (as containers are non-persistent, no data will be lost)',
                            'Permanently deletes all unused images',
                            'Clears build cache',
                            'Removes old versions of the Hostly helper image',
                ...
                <div class="flex flex-col">
                    <div class="flex flex-wrap gap-2 sm:flex-nowrap pt-4">
                        <x-forms.input id="serverDiskUsageNotificationThreshold"
                            ...
                            helper="If the server disk usage exceeds this threshold, Hostly will send a notification to the team members." />
                    </div>
                </div>
                <div class="flex flex-col gap-2">
                    ...
                    <div class="flex flex-wrap items-center gap-4">
                        ...
                        <ul class='list-disc pl-4 mt-2'>
                            <li>Removes stopped containers managed by Hostly (as containers are none persistent, no data will be lost).</li>
                            <li>Deletes unused images.</li>
                            <li>Clears build cache.</li>
                            <li>Removes old versions of the Hostly helper image.</li>
