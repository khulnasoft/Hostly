<div>
    <x-slot:title>
        {{ data_get_str($server, 'name')->limit(10) }} > Cloudflare Tunnels | Hostly
    </x-slot>
                ...
                @elseif (!$server->isFunctional())
                    <div
                        ...
                        For more information, please read our <a
                            href="https://hostly.khulnasoft.com/docs/knowledge-base/cloudflare/tunnels/" target="_blank"
