        ...
        @if (data_get($server, 'proxy.status') === 'running')
            <div class="flex gap-2">
                ...
                <x-modal-confirmation 
                    ...
                    :actions="['This proxy will be stopped and started again.', 'All resources hosted on hostly will be unavailable during the restart.']"
                ...
                <x-modal-confirmation 
                    ...
                    :actions="['The hostly proxy will be stopped.', 'All resources hosted on hostly will be unavailable.']"
                    :confirmWithText="false"
                    :confirmWithPassword="false"
