...
<section class="flex flex-col h-full lg:items-center lg:justify-center">
    <div
        ...
        @if ($currentState === 'welcome')
            <h1 class="text-3xl font-bold lg:text-5xl">Welcome to Hostly</h1>
        ...
        @elseif ($currentState === 'explanation')
            <x-boarding-step title="What is Hostly?">
                <x-slot:question>
                    Hostly is an all-in-one application to automate tasks on your servers, deploy applications with
                    Git
                    integrations, deploy databases and services, monitor these resources with notifications and
                    alerts
                    without vendor lock-in. <br/>
                <a href="https://hostly.khulnasoft.com" class="dark:text-white hover:underline">Hostly Home</a>.
                    <br><br>
                    <span class="text-xl">
                ...
                <x-slot:explanation>
                    ...
                    <p>
                        ...
                        everything works without a connection to Hostly (except integrations and automations).
                    </p>
                    <p>
        ...
        @elseif ($currentState === 'select-server-type')
            <x-boarding-step title="Server">
                        ...
                        <div class="mt-6 p-4 border border-error rounded-lg text-gray-800 dark:text-gray-200">
                                ...
                                <div>
                                    ...
                                    <p class="text-xs mt-1">
                                        ...
                                        <a class="font-bold underline" target="_blank"
                                            href="https://hostly.khulnasoft.com/docs/knowledge-base/server/non-root-user">docs</a>
                                    </p>
                                </div>
                            </div>
                            ...
                            <div class="mb-4">
                                ...
                                <ul class="list-disc list-inside">
                                    ...
                                    <li>Or skip the boarding process and manually add a new private key to Hostly and
                                        the server</li>
                                </ul>
                            </div>
                            ...
                            <p class="mb-4">
                                For more help, check this <a target="_blank" class="underline font-semibold"
                                    href="https://hostly.khulnasoft.com/docs/knowledge-base/server/openssh">documentation</a>.
                            </p>
                ...
                <x-slot:explanation>
                    ...
                    <p>
                        <x-highlighted text="Localhost" /> is the server where Hostly is running on. It is not
        ...
        @elseif ($currentState === 'private-key')
            <x-boarding-step title="SSH Key">
                ...
                <x-slot:explanation>
                    ...
                    <p>You can use your own ssh private key, or you can let Hostly to create one for you.</p>
        ...
        @elseif ($currentState === 'select-existing-server')
            <x-boarding-step title="Select a server">
                ...
                <x-slot:explanation>
                    ...
                    <p>You can use your own private key, or you can let Hostly to create one for you.</p>
