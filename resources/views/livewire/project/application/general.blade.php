 ...
 --}}
        ...
        <div class="flex flex-col gap-2 py-4">
            ...
            @if ($application->build_pack !== 'dockercompose')
                <div class="flex items-center gap-2 pt-8">
                    ...
                    @if ($application->build_pack !== 'dockerimage' && !$application->destination->server->isSwarm())
                        <x-helper
                            helper="Push the built image to a docker registry. More info <a class='underline' href='https://hostly.khulnasoft.com/docs/knowledge-base/docker/registry' target='_blank'>here</a>." />
                    @endif
                </div>
                @if ($application->destination->server->isSwarm())
                    @if ($application->build_pack !== 'dockerimage')
                        <div>Docker Swarm requires the image to be available in a registry. More info <a
                                class="underline" href="https://hostly.khulnasoft.com/docs/knowledge-base/docker/registry"
                    ...
                    @if ($application->could_set_build_commands())
                        @if ($application->build_pack === 'nixpacks')
                            ...
                            <div class="pt-1 text-xs">Nixpacks will detect the required configuration
                                automatically.
                                <a class="underline"
                                    href="https://hostly.khulnasoft.com/docs/applications">Framework
                                    Specific Docs</a>
                            </div>
                        @endif
                    ...
                    <div class="flex flex-col gap-2 pt-6 pb-10">
                        ...
                        @else
                            ...
                            @if ($application->build_pack !== 'dockercompose')
                                <div class="pt-2 w-96">
                                    <x-forms.checkbox
                                        helper="Use a build server to build your application. You can configure your build server in the Server settings. For more info, check the <a href='https://hostly.khulnasoft.com/docs/knowledge-base/server/build-server' class='underline' target='_blank'>documentation</a>."
            ...
            @if ($application->build_pack === 'dockercompose')
                ...
                <div class="w-96">
                    ...
                    <x-forms.checkbox label="Readonly labels"
                        helper="If you know what are you doing, you can enable this to edit the labels directly. Hostly won't update labels automatically. <br><br>Be careful, it could break the proxy configuration after you restart the container."
            ...
            @if ($application->build_pack !== 'dockercompose')
                ...
                <x-modal-confirmation title="Confirm Labels Reset to Hostly Defaults?"
                    ...
                    :actions="[
                        ...
                        'Proxy labels (traefik, caddy, etc) will be reset to the hostly defaults.',
