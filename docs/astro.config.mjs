...
export default defineConfig({
  base: "/docs",
  site: "https://hostly.khulnasoft.com/docs",
  redirects: {
    ...
    "/knowledge-base/contribute/hostly": "/docs/contribute/hostly",
      ...
      head: [
        ...
        },
        {
          ...
          attrs: {
            property: "og:image",
            content:
              "https://coolcdn.b-cdn.net/assets/hostly/og-image-docs.png",
          },
        },
        {
          tag: "meta",
          attrs: {
            property: "og:url",
            content: "https://hostly.khulnasoft.com/docs",
          },
        },
        {
          tag: "meta",
          ...
          items: [
            ...
            },
            {
              ...
              items: [
                ...
                {
                  label: "Hostly Updates",
                  link: "/knowledge-base/hostly-updates",
                },
