...
head:
  - tag: "meta"
    attrs:
        property: "og:title"
        content: "Configure Sentinel and Metrics in Hostly"
description: "Learn how to set up and use Sentinel as a Linux API and metrics collection tool for server and container metrics in Hostly"
---
...
[Sentinel](https://github.com/khulnasoft/sentinel) is an open-source lightweight container that provides:
- Linux system API
