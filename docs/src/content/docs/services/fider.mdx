...
head:
  - tag: "meta"
    attrs:
        property: "og:title"
        content: "How to host Fider with Hostly"
description: "Here you can find the documentation for hosting Fider with Hostly."
---
...
- [The official website ›](https://fider.io?utm_source=hostly.khulnasoft.com)
