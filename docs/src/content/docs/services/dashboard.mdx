...
head:
  - tag: "meta"
    attrs:
        property: "og:title"
        content: "How to host Dashboard with Hostly"
description: "Here you can find the documentation for hosting Dashboard with Hostly."
---
...
- [GitHub ›](https://github.com/phntxx/dashboard?utm_source=hostly.khulnasoft.com)
