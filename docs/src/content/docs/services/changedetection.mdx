...
head:
  - tag: "meta"
    attrs:
        property: "og:title"
        content: "How to host Change Detection with Hostly"
description: "Here you can find the documentation for hosting Change Detection with Hostly."
---
...
- Configurable [proxy per watch](https://github.com/dgtlmoon/changedetection.io/wiki/Proxy-configuration?utm_source=hostly.khulnasoft.com)
- Send a screenshot with the notification when a change is detected in the web page.

## Links

- [The official website ›](https://changedetection.io?utm_source=hostly.khulnasoft.com)
- [GitHub ›](https://github.com/dgtlmoon/changedetection.io?utm_source=hostly.khulnasoft.com)
