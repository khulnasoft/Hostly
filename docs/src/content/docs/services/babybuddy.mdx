...
head:
  - tag: "meta"
    attrs:
        property: "og:title"
        content: "How to host BabyBuddy with Hostly"
description: "Here you can find the documentation for hosting BabyBuddy with Hostly."
---
...
A [demo of Baby Buddy](https://demo.baby-buddy.net?utm_source=hostly.khulnasoft.com) is available. The demo instance
...
- [The official website ›](https://docs.baby-buddy.net?utm_source=hostly.khulnasoft.com)
- [GitHub ›](https://github.com/babybuddy/babybuddy?utm_source=hostly.khulnasoft.com)
