...
head:
  - tag: "meta"
    attrs:
        property: "og:title"
        content: "How to host DokuWiki with Hostly"
description: "Here you can find the documentation for hosting DokuWiki with Hostly."
---
...
- [The official website ›](https://www.dokuwiki.org?utm_source=hostly.khulnasoft.com)
- [GitHub ›](https://github.com/splitbrain/DokuWiki?utm_source=hostly.khulnasoft.com)
