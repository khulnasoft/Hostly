...
head:
  - tag: "meta"
    attrs:
        property: "og:title"
        content: "How to host Emby Stat with Hostly"
description: "Here you can find the documentation for hosting Emby Stat with Hostly."
---
...
- [The official website ›](https://github.com/mregni/EmbyStat?utm_source=hostly.khulnasoft.com)
