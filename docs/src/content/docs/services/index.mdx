...
head:
  - tag: "meta"
    attrs:
        property: "og:title"
        content: "What kind of one-click services could you host with Hostly"
description: "Here you can find all the one-click services that you can host with Hostly."
---

import { Aside } from '@astrojs/starlight/components';

This list only includes services that are available as one-click services in Hostly.

<Aside type="tip">
You can host ANY service with Hostly that could be containerized.
</Aside>
