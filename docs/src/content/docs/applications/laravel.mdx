...
head:
  - tag: "meta"
    attrs:
      property: "og:title"
      content: "How to deploy Laravel with Hostly"
description: "A guide on how to deploy Laravel with Hostly"
---
...
Example repository [here](https://github.com/khulnasoft/hostly/tree/main/examples/tree/main/laravel).
...
If your application needs a database or Redis, you can simply create them beforehand in the Hostly dashboard.
