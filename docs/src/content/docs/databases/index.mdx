...
head:
  - tag: "meta"
    attrs:
        property: "og:title"
        content: "Databases you can host with Hostly"
description: "An overview of the databases supported by Hostly and their characteristics."
---

import { Aside } from '@astrojs/starlight/components';

Hostly supports a variety of databases to suit different application needs. Even if you don't see your favorite database here, you can still host it with Hostly, using Docker.

Hostly offers one-click setup for the following databases:
...
You can configure a database with a simple click. Hostly supports the following databases:
...
- The public port makes the connection/port dynamic (you can change it without restarting the database, Hostly will restart the Nginx TCP proxy for you).
