...
head:
  - tag: "meta"
    attrs:
        property: "og:title"
        content: "How to configure database backups in Hostly"
description: "A guide how backups work in Hostly."
---
import { Aside } from '@astrojs/starlight/components';

Scheduled database backups can be configured for Databases and for the Hostly PostgreSQL database itself.
...
Hostly creates a full backup of your PostgreSQL databases. You can specify which database to backup, with a comma separated list.

<Aside type="tip">Hostly's own database is also backed up using this method.</Aside>
