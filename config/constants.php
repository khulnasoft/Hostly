...
return [
    'hostly' => [
        ...
        'base_config_path' => env('BASE_CONFIG_PATH', '/data/hostly'),
        'helper_image' => env('HELPER_IMAGE', 'ghcr.io/khulnasoft/hostly-helper'),
        'is_windows_docker_desktop' => env('IS_WINDOWS_DOCKER_DESKTOP', false),
    ],

    'urls' => [
        'docs' => 'https://hostly.khulnasoft.com/docs',
        'contact' => 'https://hostly.khulnasoft.com/docs/contact',
    ],
