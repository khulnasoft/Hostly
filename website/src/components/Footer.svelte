<footer class="bg-coolgray-200/40 mt-20">
  <div class="mx-auto max-w-7xl px-6 py-12 md:flex md:items-center md:justify-between lg:px-8">
    <div class="flex justify-center space-x-6 md:order-2">
      <a href="https://khulnasoft.com/products" class="text-sm">Other Products</a>
      <a href="https://hostly.khulnasoft.com/docs/contact" class="text-sm"
      >Contact</a
    >
      <a href="https://twitter.com/khulnasoft" class="text-gray-400 hover:text-gray-500">
        <span class="sr-only">X</span>
        <svg class="h-6 w-6" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
          <path d="M13.6823 10.6218L20.2391 3H18.6854L12.9921 9.61788L8.44486 3H3.2002L10.0765 13.0074L3.2002 21H4.75404L10.7663 14.0113L15.5685 21H20.8131L13.6819 10.6218H13.6823ZM11.5541 13.0956L10.8574 12.0991L5.31391 4.16971H7.70053L12.1742 10.5689L12.8709 11.5655L18.6861 19.8835H16.2995L11.5541 13.096V13.0956Z" />
        </svg>
      </a>
      <a href="https://github.com/khulnasoft/hostly" class="text-gray-400 hover:text-gray-500">
      ...
      <a href="https://hostly.khulnasoft.com/discord" target="_blank" class=" text-white">
        <svg
          width="512"
          height="512"
          class="w-6 h-6"
