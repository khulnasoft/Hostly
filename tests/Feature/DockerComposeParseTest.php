...
//     $hostlyBranch = $environment->get('HOSTLY_BRANCH');
//     expect($hostlyBranch)->toBe('main');

//     $hostlyContainerName = $environment->get('HOSTLY_CONTAINER_NAME');
//     expect($hostlyContainerName)->toMatch('/app-[a-z0-9]{24}-[0-9]{12}/');
...
//     expect($labels)->toContain('hostly.managed=true');
//     expect($labels)->toContain('hostly.pullRequestId=0');
...
//     $hostlyBranch = $environment->get('HOSTLY_BRANCH');
//     expect($hostlyBranch)->toBe("pull/{$pullRequestId}/head");

//     $hostlyContainerName = $environment->get('HOSTLY_CONTAINER_NAME');
//     expect($hostlyContainerName)->toMatch("/app-[a-z0-9]{24}-pr-{$pullRequestId}/");
...
//     expect($labels)->not->toBeNull();
//     expect($labels)->toContain('hostly.managed=true');
//     expect($labels)->toContain("hostly.pullRequestId={$pullRequestId}");
