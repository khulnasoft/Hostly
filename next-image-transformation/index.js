...
Bun.serve({
    ...
    async fetch(req) {
        ...
        if (url.pathname === "/") {
            return new Response(`<h3>Next Image Transformation v${version}</h3>More info <a href="https://github.com/khulnasoft/hostly/tree/main/next-image-transformation">https://github.com/khulnasoft/hostly/tree/main/next-image-transformation</a>.`, {
                headers: {
        ...
        return Response.redirect("https://github.com/khulnasoft/hostly/tree/main/next-image-transformation", 302);
    }
});
...
async function resize(url) {
    ...
    if (allowed.length === 0) {
        return new Response(`Domain (${origin}) not allowed. More details here: https://github.com/khulnasoft/hostly/tree/main/next-image-transformation`, { status: 403 });
    }
